// BUGGY-V5: Sort param is vulnerable to SQL injection (no whitelist)
...
// BUG: sort field is directly interpolated without whitelist
router.get('/', (req: Request, res: Response) => {
  ...
  // BUG: No whitelist — direct string interpolation
